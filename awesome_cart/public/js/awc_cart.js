  ...
  setupPage: function() {
		awc_utils.get_user_addresses(function(err, addresses) {
			if ( err ) {
				...
				var $shipping_container = $("#shipping-addrs");
				var $billing_container = $("#billing-addrs");
				...
				awc_utils.build_address_widget($shipping_container, {
					...
					on_init: function($widget) {
						var $container = $widget.find('.addresses-container');
						...
						$pickup_option.click(function() {
							...
							$(this).find('.addr').addClass("selected");
            ...
            $shipping_container.find(".addresses-container div.addr[data-name=" + $(this).closest("div").attr("data-name") + "]").parent().remove();
					},
            ...
            $addr.closest('.address-item').remove();
            $billing_container.find(".addresses-container div.addr[data-name=" + $(this).closest("div").attr("data-name") + "]").parent().remove();
					},
